...
class App(object):
    ...
    def draw_lines(self):
        ...
        for row in range(1, 9):
            ...
            pygame.draw.line(self._display_surf, (255,0,0), (0,v_line), (right,v_line), v_thickness)
            for col in range(1, 9):
                ...
                pygame.draw.line(self._display_surf, (255,0,0), (h_line, 0), (h_line,bottom), h_thickness)
